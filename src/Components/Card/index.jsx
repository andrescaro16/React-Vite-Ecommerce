...
const Card = ({product}) => {
	...
	const { incrementProductCounter, toggleProductDetail, setProductToShow } = useShopiContext();
	...
	return (
		...
		>
			<figure className="relative mb-3 w-full h-4/5">
				...
				<button className="absolute top-1 right-1 w-5 h-5 flex justify-center items-center bg-white rounded-full font-medium" onClick={(event) => {event.stopPropagation(); incrementProductCounter();}}>
